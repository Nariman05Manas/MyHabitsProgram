...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
        ...
        func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
            ...
            appearanceTabBar.stackedLayoutAppearance.selected.titleTextAttributes = [ .foregroundColor: ConstSize.purpurColor]
            appearanceTabBar.stackedLayoutAppearance.selected.iconColor = ConstSize.purpurColor
