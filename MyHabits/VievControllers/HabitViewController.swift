...
class HabitViewController: UIViewController {
    ...
    var habitColor: UIColor = ConstSize.standartColor {
        didSet {
    ...
    lazy var colorButton: UIButton = {
        ...
        colorButton.backgroundColor = habitColor
        colorButton.layer.cornerRadius = ConstSize.circleSize / 2
    ...
    lazy var datePicker: UIDatePicker = {
        ...
        datePicker.tintColor = ConstSize.purpurColor
    ...
    lazy var cancelButton: UIButton = {
        ...
        button.setTitleColor(ConstSize.purpurColor, for: .normal)
    ...
    func useConstraint() {
        ...
        [stackHeaderView.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor),
         ...
         nameLabel.topAnchor.constraint(equalTo: stackHeaderView.bottomAnchor, constant: ConstSize.titleIndent),
         nameLabel.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: ConstSize.leadingMargin),
         nameLabel.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: ConstSize.trailingMargin),
         nameLabel.heightAnchor.constraint(equalToConstant: nameLabel.font.pointSize),
         
         nameTextField.topAnchor.constraint(equalTo: nameLabel.bottomAnchor, constant: ConstSize.indent),
         nameTextField.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: ConstSize.leadingMargin),
         nameTextField.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: ConstSize.trailingMargin),
         
         colorLabel.topAnchor.constraint(equalTo: nameTextField.bottomAnchor, constant: ConstSize.indent),
         colorLabel.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: ConstSize.leadingMargin),
         colorLabel.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: ConstSize.trailingMargin),
        
         colorButton.topAnchor.constraint(equalTo: colorLabel.bottomAnchor, constant: ConstSize.indent),
         colorButton.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: ConstSize.leadingMargin),
         colorButton.heightAnchor.constraint(equalToConstant: ConstSize.circleSize),
         colorButton.widthAnchor.constraint(equalToConstant: ConstSize.circleSize),
         
         dateLabel.topAnchor.constraint(equalTo: colorButton.bottomAnchor, constant: ConstSize.indent),
         dateLabel.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: ConstSize.leadingMargin),
         dateLabel.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: ConstSize.trailingMargin),
         
         dateText.topAnchor.constraint(equalTo: dateLabel.bottomAnchor, constant: ConstSize.indent),
         dateText.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: ConstSize.leadingMargin),
         
         dateValue.topAnchor.constraint(equalTo: dateLabel.bottomAnchor, constant: ConstSize.indent),
         dateValue.leadingAnchor.constraint(equalTo: dateText.trailingAnchor, constant: ConstSize.leadingMargin),
         
         datePicker.topAnchor.constraint(equalTo: dateText.bottomAnchor, constant: ConstSize.indent),
         datePicker.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: ConstSize.leadingMargin),
         datePicker.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: ConstSize.leadingMargin),
         
         deleteButton.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor, constant: ConstSize.downIndent),
